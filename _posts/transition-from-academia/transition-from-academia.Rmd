...
```{r, echo = FALSE, out.width = "250px", warning = FALSE, message = FALSE, fig.align = "center"}
library(knitr)
...
```{r, eval=FALSE, echo = FALSE, out.width = "30%", fig.align = "center", fig.cap = "My brain doesn't even listen when I'm doing my best Arnie impersonation"}
knitr::include_graphics("gif2.gif")
```

<!-- ![My brain doesn't even listen when I'm doing my best Arnie impersonation](gif2.gif) -->
...
<!-- ![I like that dream because usually my dreams are more like this](gif3.gif) -->
...
<!-- ![A real team huddle I once had](gif4.gif) -->
...
<!-- ![If Paul says it you know it's true](gif5.gif) -->

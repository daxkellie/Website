...
```{r, eval=FALSE, echo = FALSE, preview = TRUE}
tweet_screenshot(tweet_url("AMLuger", "1369348381630472194?s=20"))
```

```{r, eval=FALSE, echo = FALSE, fig.cap = "A few tweets I liked. The Michele Meyer thread is worth reading. Also note that Jessie Sun stayed in academia and just got a killer Assistant Prof position woo!"}
...
![](https://media.giphy.com/media/3ohc0QqLZIyTraBWdq/giphy.gif)
...
![My brain doesn't even listen when I'm doing my best Arnie impersonation](https://media.giphy.com/media/d2kQseYEBMzaU/giphy.gif)
...
![A real team huddle I once had](https://media.giphy.com/media/3rgXBrLlRs4ZlpnVDO/giphy.gif)
...
![If Paul says it you know it's true](https://media.giphy.com/media/xT8qAYITi1l7A6m5eo/giphy.gif)
